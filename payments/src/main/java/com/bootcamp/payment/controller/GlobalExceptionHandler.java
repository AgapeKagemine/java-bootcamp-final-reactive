...
import com.bootcamp.payment.exception.NotFoundException;
import com.bootcamp.payment.exception.PaymentsException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<String> handleNotFoundException(PaymentsException ex) {
        log.error("Not found error: {}", ex.getMessage());
